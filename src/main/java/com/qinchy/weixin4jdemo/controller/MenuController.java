...
public class MenuController {
    ...
    public String get() {
        return WeixinRequestUtils.request(WeixinUrlEnum.Menu.GET, null);
    }
    ...
    public String create(String body) {
        ...
        return WeixinRequestUtils.request(WeixinUrlEnum.Menu.CREATE, body);
    }

    @RequestMapping(path = "/delete", method = RequestMethod.GET)
    public String delete() {
        return WeixinRequestUtils.request(WeixinUrlEnum.Menu.DELETE, null);
    }
}
